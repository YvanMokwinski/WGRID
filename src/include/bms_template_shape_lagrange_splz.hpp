...
template<wmesh_int_t 	degree_,
	 ...
	 typename 	T>
struct bms_template_shape_lagrange_splz
{  
...
struct bms_template_shape_lagrange_splz<0,ELEMENT_,T>
{
...
template<typename T>
struct bms_template_shape_lagrange_splz<1,WMESH_ELEMENT_EDGE,T>
{
...
template<typename T>
struct bms_template_shape_lagrange_splz<1,WMESH_ELEMENT_TRIANGLE,T>
{
...
template<typename T>
struct bms_template_shape_lagrange_splz<1,WMESH_ELEMENT_QUADRILATERAL,T>
{
...
template<typename T>
struct bms_template_shape_lagrange_splz<1,WMESH_ELEMENT_TETRAHEDRON,T>
{
...
template<typename T>
struct bms_template_shape_lagrange_splz<1,WMESH_ELEMENT_WEDGE,T>
{
...
template<typename T>
struct bms_template_shape_lagrange_splz<1,WMESH_ELEMENT_HEXAHEDRON,T>
{
...
template<typename T>
struct bms_template_shape_lagrange_splz<1,WMESH_ELEMENT_PYRAMID,T>
{
