#pragma once
#include "bms_template_shape_legendre_splz.hpp"

template<wmesh_int_t 	ELEMENT_,
	 typename 	T>
struct bms_template_shape_legendre
{  
...
#define FORWARD					\
      ...
      case 0:
	{
	  return bms_template_shape_eval(FORWARD,
					 bms_template_shape_legendre_splz<0,ELEMENT_,T>::basis);
	}
      case 1:
	{
	  return bms_template_shape_eval(FORWARD,
					 bms_template_shape_legendre_splz<1,ELEMENT_,T>::basis);
	}
      }
