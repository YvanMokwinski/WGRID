...
CFLAGS= -pipe -m64 -Wall  -funroll-loops -funroll-all-loops -DWMESH_ILP64=1     -DWMESH_MKL_BLAS  -I/home/mokwinski/intel/compilers_and_libraries_2020.1.217/linux/mkl/include/
CPPFLAGS= -pipe -m64 -Wall -funroll-loops -funroll-all-loops -DWMESH_ILP64=1 -DWMESH_MKL_BLAS  -I/home/mokwinski/intel/compilers_and_libraries_2020.1.217/linux/mkl/include/
