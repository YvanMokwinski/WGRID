...
extern "C"
{
  ...
  //!
  wmesh_status_t
  wmesh_indexing_edges_buffer_size
  ...
  //!
  wmesh_status_t
  wmesh_indexing_triangles_buffer_size
  (wmesh_int_t		c2n_size_,
   const_wmesh_int_p	c2n_n_,
   wmesh_int_p 		work_n_);
  ...
  //!
  wmesh_status_t
  wmesh_indexing_quadrilaterals_buffer_size
  (wmesh_int_t			c2n_size_,
   const_wmesh_int_p 		c2n_n_,						
  ...
  wmesh_status_t
  wmesh_space_indexing_triangles
  (wmesh_int_t 		c2n_size_,   
   const_wmesh_int_p 	c2n_ptr_,
   const_wmesh_int_p 	c2n_m_,
   const_wmesh_int_p 	c2n_n_,
  ...
  wmesh_status_t
  wmesh_space_indexing_quadrilaterals
  (wmesh_int_t 		c2n_size_,							 
   const_wmesh_int_p 	c2n_ptr_,
   const_wmesh_int_p 	c2n_m_,
   const_wmesh_int_p 	c2n_n_,
